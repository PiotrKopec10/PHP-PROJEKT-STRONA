...
<section id="special-price">
    <div class="container">
        <h4 class="font-rubik font-size-20">Zniżki</h4>
...
//                zamienianie nazwy %s
            ...
            ?>
<!--            <button class="btn" data-filter=".Nike">Nike</button>-->
<!--            <button class="btn" data-filter=".Adidas">Adidas</button>-->
<!--            <button class="btn" data-filter=".Balenciaga">Balenciaga</button>-->
        </div>

        <div class="grid">
            <?php array_map(function ($item) use($in_cart){?>
            <div class="grid-item  border <?php echo $item['item_brand'] ?? "Coś poszło nie tak :(" ;?>">
                <div class="item py-2" style="width:200px;">
                    <div class="product font-rale">
                        ...
                        <div class="text-center">
                            ...
                            ?>
                            <h6><?php echo $item['item_name'] ?? "Coś poszło nie tak :(" ?></h6>
